    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, upload_to=users.models.student.Student.upload_avatar_image_dir, validators=[django.core.validators.validate_image_file_extension], verbose_name='Фотография')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL, verbose_name='Пользователь')),
                ('avatar', models.ImageField(blank=True, upload_to=users.models.teacher.Teacher.upload_avatar_image_dir, validators=[django.core.validators.validate_image_file_extension], verbose_name='Фотография')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL, verbose_name='Пользователь')),
                ('logo', models.ImageField(blank=True, upload_to=users.models.partner.Partner.upload_logo_image_dir, validators=[django.core.validators.validate_image_file_extension], verbose_name='Логотип компании')),
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('courses', models.ManyToManyField(to='pages.Course', verbose_name='Выпусники каких курсов интересуют')),
            ],
            options={
